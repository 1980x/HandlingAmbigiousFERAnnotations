...
parser.add_argument('--noise_file', type=str, help='EmoLabel/train_label.txt/', default='EmoLabel/0.3noise_train.txt')
...
def main():
    ...
    for epoch in range(0, args.n_epoch):
        ...
        # save results
        if test_acc>= 89.0: 
           model.save_model(epoch, test_acc, 'rafdb_'+args.noise_file.split('/')[-1])
    print('\n Best acc for noise level is ', args.noise_file, best_acc )
    print('Sairam\n')
